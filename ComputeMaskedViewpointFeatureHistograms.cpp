...
// void ComputeMaskedViewpointFeatureHistograms::operator()(InputCloudType::Ptr input, MaskImageType* mask, itk::Index<2>& index,
...
void ComputeMaskedViewpointFeatureHistograms::operator()(InputCloudType::Ptr input, MaskImageType* mask,
...
void ComputeMaskedViewpointFeatureHistograms::AddToPolyData(OutputCloudType::Ptr outputCloud, vtkPolyData* const polyData)
{
